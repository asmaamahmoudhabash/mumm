...
<div id="m_aside_left" class="m-grid__item m-aside-left  m-aside-left--skin-dark ">
    ...
    <div
        ...
        <ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
            ...
            </li><li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true"  m-menu-submenu-toggle="hover"><a  href="{{url('Dashboard/categories')}}" class="m-menu__link m-menu__toggle"><i class="m-menu__link-icon flaticon-layers"></i><span class="m-menu__link-text">Categories</span></a>
            </li>
        </ul>
